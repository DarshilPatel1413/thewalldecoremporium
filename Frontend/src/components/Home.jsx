          ...
          <div className="detail pt-8  pl-10">
            ...
            <div className=" text-center text-wrap">
              <p className="p1 text-lg text-pretty px-2 text-white bg-orange-400 sm:w-auto w-80 rounded-lg h-auto py-1 hover:text-black">
                {" "}
                Shop Expensive Products | Got Affordable Price | Make Wall
                Decorative
              </p>
              ...
              <p className=" sm:hidden block rounded-full border-2 border-black text-4xl text-center px-4  hover:text-orange-500 pb-2 w-fit ml-20 hover:cursor-pointer">
                50% Off
              </p>
            </div>
            <br />
            ...
            <div className="contact grid grid-cols-2 sm:flex sm:justify-evenly gap-0 ">
              ...
              <div>
                <i className="fa-solid fa-phone"></i>+91 9857 1455
              </div>
              ...
              <Link to={`${item.path}`}>
                <div className="pb-12">
                  <img
                    src={item.image}
                    alt="img"
                    className="w-10/12 rounded-lg hover:scale-95 duration-750"
                  />
                  <br />
                  <p className="text-2xl pl-4 hover:underline underline-offset-4">
                    {item.name} <span>--{">"}</span>
                  </p>
                </div>
              </Link>
