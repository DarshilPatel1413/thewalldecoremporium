...
function Navbar({ notificationCount }) {
  ...
  let itemss = names.reduce((def, items) => def + parseInt(items.quantity), 0);
  ...
  return (
    <div className="navbar relative h-fit bg-slate-400 pt-7 py-3">
      <div className="nav">
        ...
        <div
          id="slidebar"
          className="slidebar hidden absolute top-16 left-14 px-9 py-5 font-semibold text-xl w-60 bg-slate-500 h-72"
        >
          <div onClick={exit}>
