  ...
  return (
    <>
      ...
      <form
        ...
        className=" border sm:w-2/4 sm:ml-40 md:ml-80 sm:mt-20 md:my-3 mt-10 w-full py-5 bg-slate-200 rounded-xl"
      >
        <h1 className="text-4xl text-center pb-10 underline underline-offset-8">
          Create New Account
        </h1>
        ...
        <div className="flex flex-col items-center gap-5 ">
          <input
            ...
            className="border-4 p-2 rounded-md w-60 sm:w-80"
          />
          ...
          <input
            ...
            className="border-4 rounded-md w-60 sm:w-80 p-2"
          />
          ...
          <button
            type="submit"
            className="border border-stone-950 px-2 pb-1 mt-5 mb-2 bg-blue-600 text-white rounded-lg"
          >
            Create New
          </button>
          <Link
            to={"/"}
            className="text-xs ml-20 hover:text-lime-950 hover:font-bold"
          >
