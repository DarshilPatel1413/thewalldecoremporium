...
function Refund() {
  ...
  return (<>
    ...
    <div className='w-full justify-center p-10 pl-14 bg-slate-100'>
      ...
      <h1>Can I return a product if I do not like it?</h1><br />

<h1>We have a strict No Returns Policy. Return/exchange is only possible if the delivered product is damaged or incorrect.</h1><br />

<p>What if I receive a damaged or incorrect product?</p><br />
